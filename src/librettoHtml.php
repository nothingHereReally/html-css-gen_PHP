<?php
require_once "../HTMLGenerator/CreateHtml.php";
require_once "../HTMLGenerator/generateHeading.php";
require_once "../HTMLGenerator/generateDiv.php";
require_once "../HTMLGenerator/generatePara.php";
require_once "../HTMLGenerator/generateButton.php";
require_once "../HTMLGenerator/generateInput.php";
require_once "../HTMLGenerator/generateLink.php";
require_once "../HTMLGenerator/generateTable.php";
require_once "../HTMLGenerator/generateFooter.php";
require_once "../HTMLGenerator/generateSection.php";
require_once "../HTMLGenerator/generateNav.php";
require_once "../HTMLGenerator/generateHeader.php";
require_once "../HTMLGenerator/generateList.php";
require_once "../HTMLGenerator/generateSpan.php";
require_once "../HTMLGenerator/generateImage.php";
require_once "../HTMLGenerator/br.php";
require_once "../HTMLGenerator/index.php";



// $html = new CreateHtml('libretto3', 'final project', 'style');
...
// // ->newul([
// //     $html->list->newli(["Home"]),
// //     $html->list->newli(["Reading"]),
// //     ])
